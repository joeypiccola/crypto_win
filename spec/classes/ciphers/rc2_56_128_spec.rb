...
describe 'crypto_win::ciphers::rc2_56_128' do
  ...
  on_supported_os(facterversion: '2.4').each do |os, os_facts|
    context "on #{os}" do
      ...
      context 'passes with minimal params' do
        it {
          is_expected.to contain_registry_key('rc2_56_128').with(
            'ensure' => 'present',
        ...
        it {
          is_expected.to contain_registry_value('rc2_56_128_enabled').with(
            'ensure' => 'present',
