...
describe 'crypto_win::protocols::pct_1_0' do
  ...
  on_supported_os(facterversion: '2.4').each do |os, os_facts|
    context "on #{os}" do
      ...
      context 'passes with minimal params' do
        it {
          is_expected.to contain_registry_key('pct_1_0').with(
            'ensure' => 'present',
        ...
        it {
          is_expected.to contain_registry_key('pct_1_0_client').with(
            'ensure' => 'present',
        ...
        it {
          is_expected.to contain_registry_key('pct_1_0_server').with(
            'ensure' => 'present',
        ...
        it {
          is_expected.to contain_registry_value('pct_1_0_client_DisabledByDefault').with(
            'ensure' => 'present',
        ...
        it {
          is_expected.to contain_registry_value('pct_1_0_client_Enabled').with(
            'ensure' => 'present',
        ...
        it {
          is_expected.to contain_registry_value('pct_1_0_server_DisabledByDefault').with(
            'ensure' => 'present',
        ...
        it {
          is_expected.to contain_registry_value('pct_1_0_server_Enabled').with(
            'ensure' => 'present',
